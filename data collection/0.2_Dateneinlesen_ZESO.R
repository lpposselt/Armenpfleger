...
files_location <- list.files("/Volumes/PhD/PhD_Webscraping/ZESO",
                             full.names = TRUE)
files_name <- list.files("/Volumes/PhD/PhD_Webscraping/ZESO")
...
getwd()
saveRDS(output, file="DATA/1_Rohdaten_ZESO.rds")
