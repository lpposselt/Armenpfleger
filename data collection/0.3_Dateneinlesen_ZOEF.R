...
files_location <- list.files("/Volumes/PhD/PhD_Webscraping/ZOEF",
                             full.names = TRUE)
files_name <- list.files("/Volumes/PhD/PhD_Webscraping/ZOEF")
...
as.character(output$title)[1000]
...
getwd()
saveRDS(output, file="DATA/1_Rohdaten_ZOEF.rds")
